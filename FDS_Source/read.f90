...
IMPLICIT NONE
PRIVATE
CHARACTER(255), PARAMETER :: readid='$Id: read.f90 22706 2015-05-21 14:50:24Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: readrev='$Revision: 22706 $'
CHARACTER(255), PARAMETER :: readdate='$Date: 2015-05-21 10:50:24 -0400 (Thu, 21 May 2015) $'
