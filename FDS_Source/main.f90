PROGRAM FDS  
! dummy change made in branch test_branch - (third conflict test blaze - gpf)
...
CHARACTER(255), PARAMETER :: mainid='$Id: main.f90 22712 2015-05-22 01:56:37Z fds.firebot $'
CHARACTER(255), PARAMETER :: mainrev='$Revision: unknown $'
CHARACTER(255), PARAMETER :: maindate='$Date: 2015-05-21 21:56:37 -0400 (Thu, 21 May 2015) $'
