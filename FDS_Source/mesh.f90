...
CHARACTER(255), PARAMETER :: meshid='$Id: mesh.f90 22579 2015-05-01 19:31:40Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: meshrev='$Revision: 22579 $'
CHARACTER(255), PARAMETER :: meshdate='$Date: 2015-05-01 15:31:40 -0400 (Fri, 01 May 2015) $'
