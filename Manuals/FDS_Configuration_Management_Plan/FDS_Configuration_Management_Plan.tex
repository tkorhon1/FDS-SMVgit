...
\emph{SVN Repository}~$Revision: 22786 $
\end{flushright}}
...
\begin{lstlisting}
CHARACTER(255), PARAMETER :: mainid='$Id: FDS_Configuration_Management_Plan.tex 22786 2015-06-03 01:56:40Z fds.firebot $'
CHARACTER(255), PARAMETER :: mainrev='$Revision: 22786 $'
CHARACTER(255), PARAMETER :: maindate='$Date: 2015-06-02 21:56:40 -0400 (Tue, 02 Jun 2015) $'
\end{lstlisting}
